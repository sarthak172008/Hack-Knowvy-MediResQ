      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Real-time emergency departments, trauma centers, and urgent care clinics dynamically filtered.
          </p>
        </div>
        ...
        <div className="flex items-center gap-1.5 p-1 bg-slate-100 rounded-xl border border-slate-200 text-xs">
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg font-semibold transition-all ${
              filterType === 'MODERATE' ? 'bg-amber-600 text-white shadow-xs' : 'text-slate-600 hover:text-slate-900'
            }`}
          >
            Urgent Care & ER
          </button>
        ...
        <div className="lg:col-span-7 bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
          <div className="p-4 border-b border-slate-100 flex items-center justify-between bg-slate-50">
            ...
            <div className="flex items-center gap-3 text-[11px] text-slate-500">
              <span className="flex items-center gap-1">
                <span className="w-2.5 h-2.5 rounded-full bg-rose-600 inline-block" /> Level 1 / Trauma
              </span>
              <span className="flex items-center gap-1">
                <span className="w-2.5 h-2.5 rounded-full bg-blue-600 inline-block" /> Hospital / Clinic
              </span>
            </div>
          </div>
          ...
          {selectedFacility && (
            <div className="p-4 bg-slate-900 text-white flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
              <div>
                <div className="font-bold text-sm text-white">{selectedFacility.name}</div>
                <div className="text-slate-300 text-[11px] mt-0.5">
                  {selectedFacility.distanceMiles} miles away • Est. {selectedFacility.estimatedWaitMinutes} min wait
                </div>
              </div>
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  className="px-3 py-1.5 bg-white/20 hover:bg-white/30 text-white rounded-lg font-semibold flex items-center gap-1.5 transition-colors"
                >
            ...
            return (
              <div
                ...
                className={`p-4 rounded-2xl border transition-all cursor-pointer ${
                  isSelected
                    ? 'bg-rose-50/40 border-rose-500 shadow-md ring-1 ring-rose-400'
              ...
              >
                ...
                <div className="grid grid-cols-3 gap-2 mt-3 pt-3 border-t border-slate-100 text-[11px]">
                  <div>
                    <span className="text-slate-400 block text-[10px]">Wait Time:</span>
                  ...
                  <div>
                    ...
                    <span className="font-bold text-emerald-600">{fac.openStatus}</span>
                  </div>
                  <div>
                    <span className="text-slate-400 block text-[10px]">ICU Capacity:</span>
                ...
                <div className="flex items-center gap-2 mt-3.5 pt-2 border-t border-slate-100">
                  <a
                    ...
                    className="flex-1 py-1.5 px-3 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-bold flex items-center justify-center gap-1.5 transition-colors"
                  >
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    onClick={(e) => e.stopPropagation()}
                    className="flex-1 py-1.5 px-3 rounded-lg bg-rose-600 hover:bg-rose-700 text-white text-xs font-bold flex items-center justify-center gap-1.5 transition-colors"
                  >
                    <Navigation className="w-3.5 h-3.5" />
